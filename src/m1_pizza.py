...
def run_test_generate_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    expected = [rg.Point(150, 50), rg.Point(100, 100), rg.Point(50, 50), rg.Point(100, 0)]
...
def run_test_draw_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  80 red dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 170)
...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    # Test 4:
    title = 'PIZZA test 4:  200 slices, thin lines in yellow circle'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_polygon():
    ...
    # -------------------------------------------------------------------------
    title = ('POLYGON tests 3: 4 segments in lime green circle')
    window = rg.RoseWindow(550, 400, title)
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    for k in range(number_of_segments):
        line = rg.Line(points[k%number_of_segments], points[(k+1)%(number_of_segments)])
        line.color = color
        line.thickness = thickness
        line.attach_to(window)
        window.render()
...
def run_test_fancy_polygon():
    ...
    # -------------------------------------------------------------------------
    # Test 4:
    title = ('FANCY POLYGON test 4:  300 segments, hops = 61')
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(250, 180), 150)
    circle.fill_color = 'yellow'
...
def fancy_polygon(window, circle, number_of_lines, hops_to_next_point, color,
    ...
    for k in range(number_of_lines):
        line = rg.Line(points[k%number_of_lines], points[(k+hops_to_next_point)%number_of_lines])
        line.color = color
        line.thickness = thickness
        line.arrow = 'last'
        line.attach_to(window)
